      ...
      {cutList.length === 0 ? (
        ...
        <div className="bg-white border border-slate-200 rounded-sm p-6 shadow-sm">
          <div className="flex items-center space-x-2 mb-6 pb-3 border-b border-slate-200">
            ...
            <span className="font-bold text-slate-900">Cutting Checklist</span>
          </div>
          ...
          <div className="space-y-4">
            {cutList.map((item, idx) => (
              <div 
                key={idx}
                className="flex items-center justify-between p-4 rounded-sm bg-white border border-slate-200 hover:border-primary/25 transition-all group"
              >
                {/* Dimensions Display */}
                <div>
                ...
                <div className="flex items-center space-x-4">
                  <div className="bg-primary/10 text-primary px-4 py-2 rounded-sm text-center min-w-[80px]">
