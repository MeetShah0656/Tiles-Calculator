      ...
      <div className="grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-4">
        ...
        <div className="bg-white border border-slate-200 rounded-sm p-5 shadow-sm relative overflow-hidden group">
          ...
          <div className="mt-4">
            ...
            <p className="text-2xl font-bold text-slate-900 mt-1">{formatCurrency(monthlyRevenue)}</p>
          </div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 gap-6 lg:grid-cols-3">
        ...
        <div className="bg-white border border-slate-200 rounded-sm p-6 shadow-sm">
          ...
          <div className="space-y-4">
            <div className="flex justify-between items-center p-3.5 rounded-sm bg-white border border-slate-200">
            ...
            <div className="flex justify-between items-center p-3.5 rounded-sm bg-white border border-slate-200">
              ...
              <span className="text-lg font-bold text-slate-900">{todaysArea.toFixed(2)} sq ft</span>
            </div>
            <div className="flex justify-between items-center p-3.5 rounded-sm bg-white border border-slate-200">
        ...
        <div className="bg-white border border-slate-200 rounded-sm p-6 shadow-sm lg:col-span-2">
                ...
                <tbody className="divide-y divide-slate-200">
                  {jobs.slice(0, 5).map((job) => (
                    <tr key={job.id} className="group hover:bg-slate-50">
                      ...
                      <td className="py-3.5 px-4 text-sm text-slate-650">
                        {job.projectName}
                      </td>
                      <td className="py-3.5 px-4 text-sm text-right text-slate-900 font-medium">
